...
class TLDisplayStrings {
    ...
    class func WHAT_ARE_ACCOUNTS_DESC_STRING() -> String { return "An account is a collection of bitcoin addresses. With accounts, you will no longer have to manage bitcoin addresses directly anymore. Since address reuse results in a loss of privacy for people using Bitcoin, Bitcoin Secure Wallet’s HD wallet account system will automatically handle the cycling of bitcoin addresses for you, so that you don’t use the same bitcoin address more then once.\nEach account also has a reusable address. You can find it in your receive screen. Swipe all the way to right on the QRCode in your receive screen and you will find a reusable address.\nYou can create an unlimited amount of accounts with Bitcoin Secure Wallet. See the help section on how to create a new account in Bitcoin Secure Wallet.".localized }
    ...
    class func ARCBIT_ANDROID_WALLET_STRING() -> String { return "Bitcoin Secure Wallet Android Wallet".localized }
    class func ARCBIT_BRAIN_WALLET_STRING() -> String { return "Bitcoin Secure Wallet Brain Wallet".localized }
    class func ARCBIT_WEB_WALLET_STRING() -> String { return "Bitcoin Secure Wallet Web Wallet".localized }
    class func HOW_DOES_ARCBIT_WALLET_WORK_DESC_STRING() -> String { return "Bitcoin Secure Wallet used the the bitcoin wallet model (See the section ’What is a bitcoin wallet?’ to understand the 3 different security models of bitcoin software). However if you use iCloud to back up your wallet, you will be using the security box model. It is recommended that you do not use iCloud, and be responsible for your bitcoins yourself, but for those who don’t want to remember a simple backup passphrase, iCloud backup is a good alternative.".localized }
    ...
    class func HOW_DO_I_GET_BITCOINS_DESC_STRING() -> String { return "Bitcoins can be purchase from various bitcoin exchanges. Bitcoin Secure Wallet is not a bitcoin exchange. Bitcoin Secure Wallet is a bitcoin wallet. After you purchase some bitcoins from an exchange, you can move it to a bitcoin wallet.".localized }
    ...
    class func CHECK_OUT_THE_ARCBIT_ANDROID_WALLET_STRING() -> String { return "Check out the Bitcoin Secure Wallet Android Wallet".localized }
    class func CHECK_OUT_THE_ARCBIT_BRAIN_WALLET_STRING() -> String { return "Check out the Bitcoin Secure Wallet Brain Wallet".localized }
    class func CHECK_OUT_THE_ARCBIT_WEB_WALLET_STRING() -> String { return "Check out the Bitcoin Secure Wallet Web Wallet".localized }
    class func CHECK_OUT_THE_ARCBIT_WEB_WALLET_EXCLAMATION_STRING() -> String { return "Check out the Bitcoin Secure Wallet Web Wallet!".localized }
    class func CHECK_OUT_THE_NEW_ARCBIT_ANDROID_WALLET_EXCLAMATION_STRING() -> String { return "Check out the new Bitcoin Secure Wallet Android Wallet!".localized }
    ...
    class func HOW_DOES_ARCBIT_WALLET_WORK_STRING() -> String { return "How does Bitcoin Secure Wallet Wallet work?".localized }
    ...
    class func LIKE_USING_ARCBIT_STRING() -> String { return "Like using Bitcoin Secure Wallet?".localized }
    ...
    class func CHECK_OUT_THE_ARCBIT_WEB_WALLET_DESC_STRING() -> String { return "Use Bitcoin Secure Wallet on your browser to complement the mobile app. The web wallet has all the features that the mobile wallet has plus more!".localized }
    ...
    class func VIEW_ARCBIT_BRAIN_WALLET_DETAILS_STRING() -> String { return "View Bitcoin Secure Wallet Brain Wallet Details".localized }
    class func VIEW_ARCBIT_WEB_WALLET_DETAILS_STRING() -> String { return "View Bitcoin Secure Wallet Web Wallet Details".localized }
    ...
    class func WELCOME_DESC_STRING() -> String { return "Welcome to Bitcoin Secure Wallet, a user only controlled Bitcoin wallet. Start using the app now by depositing your Bitcoins here.".localized }
    ...
    class func WHAT_IS_ARCBITS_COLD_WALLET_FEATURE_STRING() -> String { return "What is Bitcoin Secure Wallet's cold wallet feature?".localized }
    ...
    class func WHAT_MAKES_ARCBIT_DIFFERENT_FROM_OTHER_BITCOIN_WALLETS_STRING() -> String { return "What makes Bitcoin Secure Wallet different from other bitcoin wallets?".localized }
    class func TRY_OUR_NEW_COLD_WALLET_FEATURE_DESC_STRING() -> String { return "With an Bitcoin Secure Wallet cold wallet feature, you can create wallets and make payments offline without exposing your private keys to an internet connected device. This feature is great for storing large amounts of bitcoins or for the security conscious minded. Check out this feature in the cold wallet section in the side menu.".localized }
    ...
    class func STEALTH_PAYMENT_NOTE_STRING() -> String { return "You are making a payment to a reusable address. Make sure that the receiver can see the payment made to them. (All Bitcoin Secure Wallet reusable addresses are compatible with other Bitcoin Secure Wallet wallets)".localized }
    ...
    class func ARCBIT_WEB_WALLET_DESC_STRING() -> String { return "\tArcBit Web Wallet is a Chrome extension. It has all the features of the mobile wallet plus more. Highlights include the ability to create multiple wallets instead of just one, and a new non-cumbersome way to generate wallets, store and spend bitcoins all from cold storage! Bitcoin Secure Wallet's new way to manage your cold storage bitcoins also offers a more compelling reason to use Bitcoin Secure Wallet's watch account feature. Now you can safely watch the balance of your cold storage bitcoins by enabling advance mode in Bitcoin Secure Wallet and importing your cold storage account public keys.\n\tUse Bitcoin Secure Wallet Web Wallet in whatever way you wish. You can create a new wallet, or you can input your current 12 word backup passphrase to manage the same bitcoins across different devices. Check out the Bitcoin Secure Wallet Web Wallet in the Chrome Web Store for more details!\n".localized }
    class func ARCBIT_BRAIN_WALLET_STRING_DESC_STRING() -> String { return "\tWith the Bitcoin Secure Wallet Brain Wallet you can safely spend your bitcoins without ever having your private keys be exposed to the internet. It can be use in conjuction with your Bitcoin Secure Wallet Wallet or as a stand alone wallet. Visit the link in the previous sceen and then checkout the overview section to see how easy it is to use the Bitcoin Secure Wallet Brain Wallet.\n".localized }
